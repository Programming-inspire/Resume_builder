...
export default function LowScoreResultScreen({ score, onUpdateResume, onGoBack }: LowScoreResultScreenProps) {
  const missingAreas = [
    'Relevant Keywords',
      ...
      <main className="flex-1 px-4 sm:px-6 md:px-8 py-8 md:py-12 overflow-y-auto">
        <div className="w-full max-w-4xl mx-auto space-y-6 md:space-y-8">
          ...
          <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6 md:p-8 text-center">
            ...
            <p className="text-gray-600 px-4">Your resume could be better aligned with the job description.</p>
          </div>
